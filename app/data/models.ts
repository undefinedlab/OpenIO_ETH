...
export interface Model {
  ...
  parameters?: string;
  tags?: string[];
  active?: boolean; // If false, model is inactive/grayed out
}

export const models: Model[] = [
  // ZK Circuits - Verifier and Prover are inactive (grayed out)
  {
    id: 'zk-verifier',
    ...
    active: false, // Inactive - grayed out
  },
  {
    id: 'zk-prover',
  ...
  // Other ZK models hardcoded away
  // {
  //   id: 'zk-arbitrage',
  ...
  // FHE Engines - Only Key Generation is available
  {
    id: 'fhe-encrypt',
    name: 'FHE Key Generation',
    author: 'openio',
    category: 'fhe',
    description: 'FHE key generation engine for fully homomorphic encryption',
    downloads: '11.3k',
    likes: '1.5k',
    updated: '6 hours ago',
    parameters: '1.2M ops',
    tags: ['FHE', 'key-generation', 'encryption'],
  },
  // Other FHE models hardcoded away - only Key Generation is available
  // {
  //   id: 'fhe-compute',
  ...
  // iO Coprocessors - Only Evaluation Circuit is available
  {
    id: 'io-execute',
    name: 'Evaluation Circuit',
    author: 'openio',
    category: 'io',
  ...
  // Other IO models hardcoded away - only Evaluation Circuit (Execute) is available
  // {
  //   id: 'io-seal',
